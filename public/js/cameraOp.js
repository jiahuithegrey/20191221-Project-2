//this is largely self contained, we need a way to send the data object (Line: 93)
// (or in takepicture function)
//to the server/storage so that we can use it in other parts of the code,
